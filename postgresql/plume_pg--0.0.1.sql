...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dct:subject', 'shared', 'Catégorie ISO 19115', NULL, 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['https://inspire.ec.europa.eu/metadata-codelist/TopicCategory'], 5),
    ...
    ('dct:spatial / dcat:bbox', 'shared', 'Rectangle d''emprise', 'Rectangle d''emprise (BBox), au format textuel WKT.', NULL, false, 'gsp:wktLiteral', false, NULL, 'POLYGON((2.1 48.3,2.1 50.5,1.8 50.5,1.8 48.3,2.1 48.3))', NULL, false, false, false, NULL, 3),
    ('dct:spatial / dcat:centroid', 'shared', 'Centroïde', 'Localisant du centre géographique des données, au format textuel WKT.', NULL, false, 'gsp:wktLiteral', false, NULL, 'POINT(-71.064544 42.28787)', NULL, false, false, false, NULL, 4),
    ...
    ('dcat:contactPoint / vcard:hasTelephone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('dct:publisher / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('dct:publisher / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('dct:creator / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('dct:creator / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('dct:rightsHolder', 'shared', 'Propriétaire', 'Organisme ou personne qui détient des droits sur les données.', NULL, true, NULL, false, NULL, NULL, NULL, true, false, false, NULL, 43),
    ('dct:rightsHolder / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('dct:rightsHolder / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('geodcat:custodian / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('geodcat:custodian / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('geodcat:distributor / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('geodcat:distributor / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('geodcat:originator / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('geodcat:originator / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('geodcat:principalInvestigator / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('geodcat:principalInvestigator / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('geodcat:processor / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('geodcat:processor / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('geodcat:resourceProvider / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('geodcat:resourceProvider / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('geodcat:user / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, 0),
    ...
    ('geodcat:user / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, 3),
    ...
    ('snum:linkedRecord', 'shared', 'Fiche distante', 'Configuration d''import des métadonnées depuis une fiche de catalogue INSPIRE.', NULL, true, NULL, false, NULL, NULL, NULL, true, false, false, NULL, 84),
    ('snum:linkedRecord / snum:csw', 'shared', 'Service CSW', 'URL de base du service CSW, sans aucun paramètre.', 'url', false, NULL, false, NULL, 'http://ogc.geo-ide.developpement-durable.gouv.fr/csw/dataset-harvestable', NULL, false, false, false, NULL, 0),
    ('snum:linkedRecord / dct:identifier', 'shared', 'Identifiant de la fiche', 'Identifiant de la fiche de métadonnées (et non de la ressource).', NULL, false, 'xsd:string', false, NULL, 'fr-120066022-jdd-d3d794eb-76ba-450a-9f03-6eb84662f297', NULL, false, false, false, NULL, 1) ;
