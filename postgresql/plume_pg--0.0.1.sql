...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dcat:distribution / <http://data.europa.eu/r5r/availability>', 'shared', 'Disponibilité', 'Niveau de disponibilité prévu pour la distribution, permettant d''apprécier le temps pendant lequel elle est susceptible de rester accessible.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://publications.europa.eu/resource/authority/planned-availability'], NULL, 4),
    ('dcat:distribution / dct:format', 'shared', 'Format', 'Format de la distribution.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://www.iana.org/assignments/media-types'], NULL, 5),
    ...
    ('dcat:distribution / dcat:accessService', 'shared', 'Service', 'Service donnant accès aux données.', NULL, true, NULL, false, NULL, NULL, NULL, true, false, false, NULL, NULL, 6),
    ...
    ('dcat:distribution / dcat:accessService / dct:conformsTo', 'shared', 'Conforme à', 'Standard ou référentiel de coordonnées auquel se conforme le service.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#DataServiceStandard','http://www.opengis.net/def/crs/EPSG/0'], NULL, 2),
    ...
    ('dcat:distribution / dct:license', 'shared', 'Licence', 'Licence sous laquelle est publiée la distribution ou conditions d''utilisation de la distribution.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#CrpaAuthorizedLicense'], NULL, 11),
