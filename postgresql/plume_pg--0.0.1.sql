...
--
-- Copyright République Française, 2021-2022.
...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dct:spatial / skos:inScheme', 'shared', 'Index géographique', 'Type de lieu, index de référence pour l''identifiant (commune, département...).', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#InseeGeoIndex'], NULL, 0),
    ...
    ('dct:spatial / skos:prefLabel', 'shared', 'Libellé', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 2),
    ...
    ('dct:spatial / dcat:centroid', 'shared', 'Centroïde', 'Localisant du centre géographique des données, au format textuel WKT.', NULL, false, 'gsp:wktLiteral', false, NULL, '<http://www.opengis.net/def/crs/EPSG/0/2154> POINT(651796.3281 6862298.5858)', NULL, false, false, false, NULL, ARRAY['show','centroid','point']::z_plume.meta_geo_tool[], 4),
    ('dct:spatial / locn:geometry', 'shared', 'Géométrie', 'Emprise géométrique, au format textuel WKT.', NULL, false, 'gsp:wktLiteral', true, NULL, '<http://www.opengis.net/def/crs/EPSG/0/2154> POLYGON((646417.3289 6857521.1356, 657175.3272 6857521.1356, 657175.3272 6867076.0360, 646417.3289 6867076.0360, 646417.3289 6857521.1356))', NULL, false, false, false, NULL, ARRAY['show','point','linestring','polygon']::z_plume.meta_geo_tool[], 5),
    ...
    ('dct:temporal / dcat:startDate', 'shared', 'Date de début', NULL, NULL, false, 'xsd:date', false, NULL, NULL, '9999-99-99', false, false, false, NULL, NULL, 0),
    ('dct:temporal / dcat:endDate', 'shared', 'Date de fin', NULL, NULL, false, 'xsd:date', false, NULL, NULL, '9999-99-99', false, false, false, NULL, NULL, 1),
    ...
    ('dct:provenance / rdfs:label', 'shared', 'Texte', NULL, NULL, false, 'rdf:langString', true, 20, NULL, NULL, true, true, false, NULL, NULL, 0),
    ...
    ('dct:conformsTo / skos:inScheme', 'shared', 'Registre', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister'], NULL, 0),
    ...
    ('dct:conformsTo / dct:type', 'shared', 'Type de standard', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 9),
    ...
    ('dcat:contactPoint / vcard:fn', 'shared', 'Nom', NULL, NULL, false, 'xsd:string', false, NULL, NULL, NULL, false, false, false, NULL, NULL, 1),
    ('dcat:contactPoint / vcard:hasEmail', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dcat:contactPoint / vcard:hasTelephone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dcat:contactPoint / vcard:hasURL', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ('dcat:contactPoint / vcard:organization-name', 'shared', 'Organisme', 'Le cas échéant, organisation dont le point de contact fait partie.', NULL, false, 'xsd:string', false, NULL, NULL, NULL, false, false, false, NULL, NULL, 5),
    ...
    ('dct:publisher / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dct:publisher / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('dct:publisher / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dct:publisher / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dct:publisher / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('dct:creator / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dct:creator / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('dct:creator / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dct:creator / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dct:creator / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('dct:rightsHolder / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dct:rightsHolder / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('dct:rightsHolder / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dct:rightsHolder / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dct:rightsHolder / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('geodcat:custodian / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('geodcat:custodian / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('geodcat:custodian / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('geodcat:custodian / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('geodcat:custodian / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('geodcat:distributor / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('geodcat:distributor / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('geodcat:distributor / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('geodcat:distributor / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('geodcat:distributor / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('geodcat:originator / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('geodcat:originator / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('geodcat:originator / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('geodcat:originator / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('geodcat:originator / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('geodcat:principalInvestigator / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('geodcat:principalInvestigator / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('geodcat:principalInvestigator / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('geodcat:principalInvestigator / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('geodcat:principalInvestigator / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('geodcat:processor / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('geodcat:processor / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('geodcat:processor / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('geodcat:processor / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('geodcat:processor / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('geodcat:resourceProvider / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('geodcat:resourceProvider / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('geodcat:resourceProvider / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('geodcat:resourceProvider / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('geodcat:resourceProvider / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('geodcat:user / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('geodcat:user / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('geodcat:user / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('geodcat:user / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('geodcat:user / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('dcat:distribution / dct:description', 'shared', 'Description', 'Description de la distribution.', NULL, false, 'rdf:langString', true, NULL, NULL, NULL, true, true, false, NULL, NULL, 2),
    ('dcat:distribution / dct:issued', 'shared', 'Date de publication', NULL, NULL, false, 'xsd:date', false, NULL, NULL, '9999-99-99', false, false, false, NULL, NULL, 3),
    ('dcat:distribution / dcatap:availability', 'shared', 'Disponibilité', 'Niveau de disponibilité prévu pour la distribution, permettant d''apprécier le temps pendant lequel elle est susceptible de rester accessible.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://publications.europa.eu/resource/authority/planned-availability'], NULL, 4),
    ('dcat:distribution / dct:type', 'shared', 'Type de distribution', 'Type de distribution.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://publications.europa.eu/resource/authority/distribution-type'], NULL, 5),
    ('dcat:distribution / dct:format', 'shared', 'Format de fichier', 'Format de fichier ou extension.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://publications.europa.eu/resource/authority/file-type'], NULL, 6),
    ('dcat:distribution / dct:format / rdfs:label', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dcat:distribution / dcat:compressFormat', 'shared', 'Format de compression', 'Format du fichier contenant les données sous une forme compressée.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://publications.europa.eu/resource/authority/file-type'], NULL, 6),
    ('dcat:distribution / dcat:compressFormat / rdfs:label', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dcat:distribution / dcat:accessService', 'shared', 'Service', 'Service donnant accès aux données.', NULL, true, NULL, false, NULL, NULL, NULL, true, false, false, NULL, NULL, 7),
    ...
    ('dcat:distribution / dcat:accessService / dct:conformsTo', 'shared', 'Conforme à', 'Standard ou référentiel de coordonnées auquel se conforme le service.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#DataServiceStandard','http://www.opengis.net/def/crs/EPSG/0','http://inspire.ec.europa.eu/metadata-codelist/ProtocolValue'], NULL, 2),
    ('dcat:distribution / dcat:accessService / dct:conformsTo / skos:inScheme', 'shared', 'Registre', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister'], NULL, 0),
    ...
    ('dcat:distribution / dcat:accessService / dct:conformsTo / dct:type', 'shared', 'Type de standard', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 9),
    ...
    ('dcat:distribution / dcat:accessService / dct:accessRights', 'shared', 'Conditions d''accès', 'Contraintes réglementaires limitant l''accès au service.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess','http://publications.europa.eu/resource/authority/access-right','http://snum.scenari-community.org/Metadata/Vocabulaire/#CrpaAccessLimitations'], NULL, 20),
    ('dcat:distribution / dcat:accessService / dct:accessRights / rdfs:label', 'shared', 'Mention', NULL, NULL, false, 'rdf:langString', true, 4, NULL, NULL, true, true, false, NULL, NULL, 1),
    ('dcat:distribution / dcat:accessService / dct:license', 'shared', 'Licence', 'Licence de mise à diposition des données via le service, ou conditions d''utilisation du service.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#CrpaAuthorizedLicense','http://publications.europa.eu/resource/authority/licence'], NULL, 21),
    ('dcat:distribution / dcat:accessService / dct:license / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://purl.org/adms/licencetype/1.1'], NULL, 1),
    ('dcat:distribution / dcat:accessService / dct:license / rdfs:label', 'shared', 'Termes', NULL, NULL, false, 'rdf:langString', true, NULL, NULL, NULL, true, true, false, NULL, NULL, 2),
    ...
    ('dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:fn', 'shared', 'Nom', NULL, NULL, false, 'xsd:string', false, NULL, NULL, NULL, false, false, false, NULL, NULL, 1),
    ('dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:hasEmail', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:hasTelephone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:hasURL', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ('dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:organization-name', 'shared', 'Organisme', 'Le cas échéant, organisation dont le point de contact fait partie.', NULL, false, 'xsd:string', false, NULL, NULL, NULL, false, false, false, NULL, NULL, 5),
    ...
    ('dcat:distribution / dcat:accessService / dct:publisher / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dcat:distribution / dcat:accessService / dct:publisher / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('dcat:distribution / dcat:accessService / dct:publisher / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dcat:distribution / dcat:accessService / dct:publisher / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dcat:distribution / dcat:accessService / dct:publisher / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('dcat:distribution / dcat:accessService / dct:creator / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dcat:distribution / dcat:accessService / dct:creator / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('dcat:distribution / dcat:accessService / dct:creator / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dcat:distribution / dcat:accessService / dct:creator / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dcat:distribution / dcat:accessService / dct:creator / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:name', 'shared', 'Nom', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 0),
    ('dcat:distribution / dcat:accessService / dct:rightsHolder / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://purl.org/adms/publishertype/1.0'], NULL, 1),
    ('dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:mbox', 'shared', 'Courriel', NULL, 'email', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 2),
    ('dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:phone', 'shared', 'Téléphone', NULL, 'phone', false, NULL, false, NULL, '+33-1-23-45-67-89', NULL, false, false, false, NULL, NULL, 3),
    ('dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:workplaceHomepage', 'shared', 'Site internet', NULL, 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 4),
    ...
    ('dcat:distribution / dcat:accessService / dct:spatial / skos:inScheme', 'shared', 'Index géographique', 'Type de lieu, index de référence pour l''identifiant (commune, département...).', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#InseeGeoIndex'], NULL, 0),
    ...
    ('dcat:distribution / dcat:accessService / dct:spatial / skos:prefLabel', 'shared', 'Libellé', NULL, NULL, false, 'rdf:langString', false, NULL, NULL, NULL, true, true, false, NULL, NULL, 2),
    ('dcat:distribution / dcat:accessService / dct:spatial / dcat:bbox', 'shared', 'Rectangle d''emprise', 'Rectangle d''emprise (BBox), au format textuel WKT.', NULL, false, 'gsp:wktLiteral', true, NULL, '<http://www.opengis.net/def/crs/EPSG/0/2154> POLYGON((646417.3289 6857521.1356, 657175.3272 6857521.1356, 657175.3272 6867076.0360, 646417.3289 6867076.0360, 646417.3289 6857521.1356))', NULL, false, false, false, NULL, ARRAY['show','bbox','rectangle']::z_plume.meta_geo_tool[], 3),
    ('dcat:distribution / dcat:accessService / dct:spatial / dcat:centroid', 'shared', 'Centroïde', 'Localisant du centre géographique des données, au format textuel WKT.', NULL, false, 'gsp:wktLiteral', false, NULL, '<http://www.opengis.net/def/crs/EPSG/0/2154> POINT(651796.3281 6862298.5858)', NULL, false, false, false, NULL, ARRAY['show','centroid','point']::z_plume.meta_geo_tool[], 4),
    ('dcat:distribution / dcat:accessService / dct:spatial / locn:geometry', 'shared', 'Géométrie', 'Emprise géométrique, au format textuel WKT.', NULL, false, 'gsp:wktLiteral', true, NULL, '<http://www.opengis.net/def/crs/EPSG/0/2154> POLYGON((646417.3289 6857521.1356, 657175.3272 6857521.1356, 657175.3272 6867076.0360, 646417.3289 6867076.0360, 646417.3289 6857521.1356))', NULL, false, false, false, NULL, ARRAY['show','point','linestring','polygon']::z_plume.meta_geo_tool[], 5),
    ...
    ('dcat:distribution / dcat:accessService / dct:temporal / dcat:startDate', 'shared', 'Date de début', NULL, NULL, false, 'xsd:date', false, NULL, NULL, '9999-99-99', false, false, false, NULL, NULL, 0),
    ('dcat:distribution / dcat:accessService / dct:temporal / dcat:endDate', 'shared', 'Date de fin', NULL, NULL, false, 'xsd:date', false, NULL, NULL, '9999-99-99', false, false, false, NULL, NULL, 1),
    ...
    ('dcat:distribution / cnt:characterEncoding', 'shared', 'Encodage', 'Encodage de la distribution.', NULL, false, 'xsd:string', false, NULL, 'ex : UTF-8, ISO-8859-1, US-ASCII...', NULL, false, false, false, NULL, NULL, 8),
    ('dcat:distribution / dcat:byteSize', 'shared', 'Taille en bytes', 'Taille en bytes de la distribution.', NULL, false, 'xsd:decimal', false, NULL, NULL, NULL, false, false, false, NULL, NULL, 9),
    ('dcat:distribution / dct:rights', 'shared', 'Propriété intellectuelle', 'Mention rappelant les droits de propriété intellectuelle sur les données, à faire apparaître en cas de réutilisation de cette distribution des données.', NULL, true, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 10),
    ('dcat:distribution / dct:rights / rdfs:label', 'shared', 'Mention', NULL, NULL, false, 'rdf:langString', true, 4, NULL, NULL, true, true, false, NULL, NULL, 1),
    ('dcat:distribution / dct:license', 'shared', 'Licence', 'Licence sous laquelle est publiée la distribution ou conditions d''utilisation de la distribution.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#CrpaAuthorizedLicense','http://publications.europa.eu/resource/authority/licence'], NULL, 11),
    ('dcat:distribution / dct:license / dct:type', 'shared', 'Type', NULL, 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://purl.org/adms/licencetype/1.1'], NULL, 1),
    ('dcat:distribution / dct:license / rdfs:label', 'shared', 'Termes', NULL, NULL, false, 'rdf:langString', true, NULL, NULL, NULL, true, true, false, NULL, NULL, 2),
    ('dcat:distribution / dct:accessRights', 'shared', 'Conditions d''accès', 'Contraintes réglementaires limitant l''accès à la distribution.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess','http://publications.europa.eu/resource/authority/access-right','http://snum.scenari-community.org/Metadata/Vocabulaire/#CrpaAccessLimitations'], NULL, 12),
    ('dcat:distribution / dct:accessRights / rdfs:label', 'shared', 'Mention', NULL, NULL, false, 'rdf:langString', true, 4, NULL, NULL, true, true, false, NULL, NULL, 1),
    ...
    ('snum:relevanceScore', 'shared', 'Score', 'Niveau de pertinance de la donnée. Plus le score est élevé plus la donnée sera mise en avant dans les résultats de recherche.', NULL, false, 'xsd:integer', false, NULL, NULL, NULL, false, false, false, NULL, NULL, 81),
    ...
    ('snum:linkedRecord', 'shared', 'Fiche distante', 'Configuration d''import des métadonnées depuis une fiche de catalogue INSPIRE.', NULL, true, NULL, false, NULL, NULL, NULL, false, false, false, NULL, NULL, 84),
    ('snum:linkedRecord / dcat:endpointURL', 'shared', 'Service CSW', 'URL de base du service CSW, sans aucun paramètre.', 'url', false, NULL, false, NULL, 'http://ogc.geo-ide.developpement-durable.gouv.fr/csw/dataset-harvestable', NULL, false, false, false, NULL, NULL, 0),
    ('snum:linkedRecord / dct:identifier', 'shared', 'Identifiant de la fiche', 'Identifiant de la fiche de métadonnées (et non de la ressource).', NULL, false, 'xsd:string', false, NULL, 'fr-120066022-jdd-d3d794eb-76ba-450a-9f03-6eb84662f297', NULL, false, false, false, NULL, NULL, 1),
	...
	LOOP
		...
		FOR tplcat IN SELECT * FROM (
			VALUES
                ...
                ('Donnée externe', 'snum:isExternal')
