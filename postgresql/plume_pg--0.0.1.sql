...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dct:conformsTo / skos:inScheme', 'shared', 'Registre', 'Registre de référence auquel appartient le standard.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister'], NULL, 0),
    ...
    ('dcat:distribution / dcat:accessService / dct:conformsTo', 'shared', 'Conforme à', 'Standard ou référentiel de coordonnées auquel se conforme le service.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://www.opengis.net/def/crs/EPSG/0','http://snum.scenari-community.org/Metadata/Vocabulaire/#DataServiceStandard'], NULL, 2),
    ('dcat:distribution / dcat:accessService / dct:conformsTo / skos:inScheme', 'shared', 'Registre', 'Registre de référence auquel appartient le standard.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister'], NULL, 0),
    ...
    ('dcat:distribution / dct:conformsTo / skos:inScheme', 'shared', 'Registre', 'Registre de référence auquel appartient le standard.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister'], NULL, 0),
    ...
    ('snum:relevanceScore', 'shared', 'Score', 'Niveau de pertinence de la donnée. Plus le score est élevé plus la donnée sera mise en avant dans les résultats de recherche.', NULL, false, 'xsd:integer', false, NULL, NULL, NULL, false, false, false, NULL, NULL, 81),
