...
CREATE TYPE z_metadata.meta_data_type AS ENUM (
	'string', 'integer', 'decimal', 'float', 'double', 'boolean', 'date', 'time', 'dateTime', 'duration', 'wktLiteral'
	) ;
...
INSERT INTO z_metadata.meta_categorie (
    ...
    ('shared', 'dct:title', false, 'Libellé', 'string', 'QLineEdit', NULL, 'Libellé explicite du jeu de données.', NULL, NULL, NULL, true, true, 0),
    ('shared', 'owl:versionInfo', false, 'Version', 'string', 'QLineEdit', NULL, 'Numéro de version ou millésime du jeu de données.', NULL, NULL, NULL, false, false, 1),
    ('shared', 'dct:description', false, 'Description', 'string', 'QTextEdit', 15, 'Description du jeu de données.', NULL, NULL, NULL, true, true, 2),
    ('shared', 'snum:isExternal', false, 'Donnée externe', 'boolean', 'QCheckBox', NULL, 'S''agit-il de la reproduction d''un jeu de données produit par un tiers ?', NULL, NULL, NULL, false, false, 3),
    ...
    ('shared', 'dcat:keyword', false, 'Mots-clé libres', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, true, false, 6),
    ...
    ('shared', 'dct:spatial / dct:identifier', false, 'Code géographique', 'string', 'QLineEdit', NULL, 'Code du département, code INSEE de la commune, etc.', NULL, NULL, NULL, true, false, 1),
    ('shared', 'dct:spatial / skos:prefLabel', false, 'Libellé', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, true, false, 2),
    ('shared', 'dct:spatial / dcat:bbox', false, 'Rectangle d''emprise', 'wktLiteral', 'QTextEdit', NULL, 'Rectangle d''emprise (BBox), au format textuel WKT.', NULL, 'POLYGON((2.1 48.3,2.1 50.5,1.8 50.5,1.8 48.3,2.1 48.3))', NULL, false, false, 3),
    ('shared', 'dct:spatial / dcat:centroid', false, 'Centroïde', 'wktLiteral', 'QLineEdit', NULL, 'Localisant du centre géographique des données, au format textuel WKT.', NULL, 'POINT(-71.064544 42.28787)', NULL, false, false, 4),
    ('shared', 'dct:spatial / locn:geometry', false, 'Géométrie', 'wktLiteral', 'QTextEdit', NULL, 'Emprise géométrique, au format textuel WKT.', NULL, NULL, NULL, false, false, 5),
    ('shared', 'dct:temporal', true, 'Couverture temporelle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, false, 10),
    ('shared', 'dct:temporal / dcat:startDate', false, 'Date de début', 'date', 'QDateEdit', NULL, NULL, NULL, NULL, '0000-00-00', false, false, 0),
    ('shared', 'dct:temporal / dcat:endDate', false, 'Date de fin', 'date', 'QDateEdit', NULL, NULL, NULL, NULL, '0000-00-00', false, false, 1),
    ('shared', 'dct:created', false, 'Date de création', 'date', 'QDateEdit', NULL, NULL, NULL, NULL, '0000-00-00', false, false, 11),
    ('shared', 'dct:modified', false, 'Date de dernière modification', 'date', 'QDateEdit', NULL, NULL, NULL, NULL, '0000-00-00', false, false, 12),
    ('shared', 'dct:issued', false, 'Date de publication', 'date', 'QDateEdit', NULL, NULL, NULL, NULL, '0000-00-00', false, false, 13),
    ...
    ('shared', 'dct:provenance / rdfs:label', false, 'Texte', 'string', 'QTextEdit', 20, NULL, NULL, NULL, NULL, true, false, 0),
    ('shared', 'adms:versionNotes', false, 'Note de version', 'string', 'QTextEdit', NULL, 'Différences entre la version courante des données et les versions antérieures.', NULL, NULL, NULL, true, false, 21),
    ...
    ('shared', 'dct:conformsTo / dct:identifier', false, 'Identifiant', 'string', 'QLineEdit', NULL, 'Identifiant du standard, s''il y a lieu. Pour un système de coordonnées géographiques, il s''agit du code EPSG.', NULL, NULL, NULL, true, false, 1),
    ('shared', 'dct:conformsTo / dct:title', false, 'Libellé', 'string', 'QLineEdit', NULL, 'Libellé explicite du standard.', NULL, NULL, NULL, true, false, 2),
    ('shared', 'dct:conformsTo / owl:versionInfo', false, 'Version', 'string', 'QLineEdit', NULL, 'Numéro ou code de la version du standard à laquelle se conforment les données.', NULL, NULL, NULL, false, false, 3),
    ('shared', 'dct:conformsTo / dct:description', false, 'Description', 'string', 'QTextEdit', NULL, 'Description sommaire de l''objet du standard.', NULL, NULL, NULL, true, false, 4),
    ('shared', 'dct:conformsTo / dct:issued', false, 'Date de publication', 'date', 'QDateEdit', NULL, 'Date de publication du standard.', NULL, NULL, '0000-00-00', false, false, 5),
    ('shared', 'dct:conformsTo / foaf:page', false, 'Page internet', NULL, 'QLineEdit', NULL, 'Chemin d''accès au standard ou URL d''une page contenant des informations sur le standard.', NULL, NULL, NULL, true, false, 6),
    ('shared', 'dct:conformsTo / dct:type', false, 'Type de standard', NULL, 'QComboBox', NULL, NULL, NULL, NULL, NULL, false, false, 7),
    ('shared', 'dcat:spatialResolutionInMeters', false, 'Résolution spatiale en mètres', 'decimal', 'QLineEdit', NULL, 'Plus petite distance significative dans le contexte du jeu de données, exprimée en mètres.', NULL, NULL, NULL, false, false, 24),
    ('shared', 'rdfs:comment', false, 'Commentaire sur la résolution spatiale', 'string', 'QTextEdit', NULL, NULL, NULL, NULL, NULL, true, false, 25),
    ('shared', 'dcat:temporalResolution', false, 'Résolution temporelle', 'duration', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, true, false, 26),
    ('shared', 'dct:accessRights', false, 'Conditions d''accès', NULL, 'QComboBox', NULL, NULL, NULL, NULL, NULL, false, false, 30),
    ('shared', 'dct:accessRights / rdfs:label', false, 'Mention', 'string', 'QTextEdit', 4, NULL, NULL, NULL, NULL, true, false, 1),
    ('shared', 'dcat:contactPoint', true, 'Point de contact', NULL, NULL, NULL, NULL, NULL, NULL, NULL, true, false, 40),
    ('shared', 'dcat:contactPoint / vcard:fn', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 1),
    ...
    ('shared', 'dcat:contactPoint / vcard:organization-name', false, 'Organisme', 'string', 'QLineEdit', NULL, 'Le cas échéant, organisation dont le point de contact fait partie.', NULL, NULL, NULL, false, false, 5),
    ...
    ('shared', 'dct:publisher / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'dct:creator / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'dct:rightsHolder / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'geodcat:custodian / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'geodcat:distributor / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'geodcat:originator / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'geodcat:principalInvestigator / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'geodcat:processor / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'geodcat:resourceProvider / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'geodcat:user / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'prov:qualifiedAttribution / prov:agent / foaf:name', false, 'Nom', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, false, false, 0),
    ...
    ('shared', 'dcat:distribution / dct:issued', false, 'Date de publication', 'date', 'QDateEdit', NULL, NULL, NULL, NULL, '0000-00-00', false, false, 2),
    ('shared', 'dcat:distribution / dct:rights', true, 'Propriété intellectuelle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false, 3),
    ('shared', 'dcat:distribution / dct:rights / rdfs:label', false, 'Mention', 'string', 'QTextEdit', 4, NULL, NULL, NULL, NULL, true, false, 1),
    ...
    ('shared', 'dcat:distribution / dct:license / rdfs:label', false, 'Termes', 'string', 'QTextEdit', NULL, NULL, NULL, NULL, NULL, true, false, 2),
    ...
    ('shared', 'snum:relevanceScore', false, 'Score', 'integer', 'QLineEdit', NULL, 'plus le score est élevé plus la donnée est mise en avant dans les résultats de recherche.', NULL, NULL, NULL, false, false, 81),
    ...
    ('shared', 'dct:identifier', false, 'Identifiant interne', 'string', 'QLineEdit', NULL, NULL, NULL, NULL, NULL, true, false, 83),
