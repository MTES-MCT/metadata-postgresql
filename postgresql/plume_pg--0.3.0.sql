...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dct:spatial', 'shared', 'Couverture géographique', 'Territoire·s décrit·s par le jeu de données.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/EuAdministrativeTerritoryUnitFrance','http://registre.data.developpement-durable.gouv.fr/plume/InseeIndividualTerritory','http://publications.europa.eu/resource/authority/atu'], NULL, NULL, 9),
