...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dct:conformsTo', 'shared', 'Conforme à', 'Standard, schéma, référentiel de coordonnées, etc. auquel se conforment les données.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/OgcEpsgFrance','http://www.opengis.net/def/crs/EPSG/0'], NULL, ARRAY['manual']::z_plume.meta_compute[], 22),
    ...
    ('dcat:distribution / dcat:accessService / dct:conformsTo', 'shared', 'Conforme à', 'Standard ou référentiel de coordonnées auquel se conforme le service.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/OgcEpsgFrance','http://www.opengis.net/def/crs/EPSG/0','http://registre.data.developpement-durable.gouv.fr/plume/DataServiceStandard'], NULL, NULL, 2),
    ...
    ('dcat:distribution / dct:conformsTo', 'shared', 'Conforme à', 'Standard, schéma, référentiel de coordonnées, etc. auquel se conforment les données de la distribution.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/OgcEpsgFrance','http://www.opengis.net/def/crs/EPSG/0'], NULL, NULL, 17),
