...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dcat:theme', 'shared', 'Thèmes', 'Classification thématique du jeu de données.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://publications.europa.eu/resource/authority/data-theme','http://inspire.ec.europa.eu/theme','http://inspire.ec.europa.eu/metadata-codelist/TopicCategory','http://registre.data.developpement-durable.gouv.fr/ecospheres/themes-ecospheres','http://inspire.ec.europa.eu/metadata-codelist/SpatialScope'], NULL, NULL, 4),
