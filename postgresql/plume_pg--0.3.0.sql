...
INSERT INTO z_plume.meta_categorie (
    ...
    ('dcat:theme', 'shared', 'Thèmes', 'Classification thématique du jeu de données.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://publications.europa.eu/resource/authority/data-theme','http://inspire.ec.europa.eu/theme','http://inspire.ec.europa.eu/metadata-codelist/TopicCategory','http://registre.data.developpement-durable.gouv.fr/ecospheres/themes-ecospheres','http://inspire.ec.europa.eu/metadata-codelist/SpatialScope','http://inspire.ec.europa.eu/metadata-codelist/PriorityDataset'], NULL, NULL, 4),
    ...
    ('dct:accrualPeriodicity', 'shared', 'Fréquence de mise à jour', 'Fréquence de mise à jour des données.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://inspire.ec.europa.eu/metadata-codelist/MaintenanceFrequency','http://publications.europa.eu/resource/authority/frequency'], NULL, NULL, 14),
    ('adms:status', 'shared', 'Statut', 'Maturité du jeu de données.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://publications.europa.eu/resource/authority/dataset-status','http://registre.data.developpement-durable.gouv.fr/plume/ISO19139ProgressCode'], NULL, NULL, 15),
    ...
    ('dct:conformsTo', 'shared', 'Conforme à', 'Standard, schéma, référentiel de coordonnées, etc. auquel se conforment les données.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/OgcEpsgFrance','http://www.opengis.net/def/crs/EPSG/0','http://registre.data.developpement-durable.gouv.fr/plume/IgnCrs'], NULL, ARRAY['manual']::z_plume.meta_compute[], 22),
    ...
    ('dcat:spatialResolutionInMeters', 'shared', 'Résolution spatiale en mètres', 'Plus petite distance significative dans le contexte du jeu de données, exprimée en mètres.', NULL, false, 'xsd:decimal', false, NULL, NULL, NULL, true, false, false, NULL, NULL, NULL, 24),
    ...
    ('dct:accessRights', 'shared', 'Conditions d''accès', 'Contraintes réglementaires limitant l''accès aux données.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess','http://publications.europa.eu/resource/authority/access-right','http://registre.data.developpement-durable.gouv.fr/plume/CrpaAccessLimitations','http://registre.data.developpement-durable.gouv.fr/plume/ISO19139ClassificationCode','http://registre.data.developpement-durable.gouv.fr/plume/ISO19139RestrictionCode'], NULL, NULL, 30),
    ...
    ('dcat:distribution / dcat:accessURL', 'shared', 'URL d''accès', 'URL de la page où est publiée cette distribution des données.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, NULL, NULL, NULL, 1),
    ...
    ('dcat:distribution / adms:status', 'shared', 'Statut', 'Maturité de la distribution.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://publications.europa.eu/resource/authority/dataset-status','http://registre.data.developpement-durable.gouv.fr/plume/ISO19139ProgressCode'], NULL, NULL, 8),
    ...
    ('dcat:distribution / dct:format', 'shared', 'Format de fichier', 'Format de fichier ou extension.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://publications.europa.eu/resource/authority/file-type','http://registre.data.developpement-durable.gouv.fr/plume/IanaMediaType'], NULL, NULL, 11),
    ...
    ('dcat:distribution / dcat:compressFormat', 'shared', 'Format de compression', 'Format du fichier contenant les données sous une forme compressée, afin de réduire leur volume.', 'url', false, NULL, false, NULL, NULL, NULL, false, false, false, ARRAY['http://publications.europa.eu/resource/authority/file-type','http://registre.data.developpement-durable.gouv.fr/plume/IanaMediaType'], NULL, NULL, 12),
    ...
    ('dcat:distribution / dcat:accessService / dct:conformsTo', 'shared', 'Conforme à', 'Standard ou référentiel de coordonnées auquel se conforme le service.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/OgcEpsgFrance','http://www.opengis.net/def/crs/EPSG/0','http://registre.data.developpement-durable.gouv.fr/plume/DataServiceStandard','http://registre.data.developpement-durable.gouv.fr/plume/IgnCrs'], NULL, NULL, 2),
    ...
    ('dcat:distribution / dcat:accessService / dct:spatial / dcat:centroid', 'shared', 'Centroïde', 'Localisant du centre géographique des données, au format textuel WKT.', NULL, false, 'gsp:wktLiteral', true, NULL, '<http://www.opengis.net/def/crs/EPSG/0/2154> POINT(651796.3281 6862298.5858)', NULL, false, false, false, NULL, ARRAY['show','centroid','point']::z_plume.meta_geo_tool[], NULL, 4),
    ('dcat:distribution / dcat:accessService / dct:spatial / locn:geometry', 'shared', 'Géométrie', 'Emprise géométrique, au format textuel WKT.', NULL, false, 'gsp:wktLiteral', true, NULL, '<http://www.opengis.net/def/crs/EPSG/0/2154> POLYGON((646417.3289 6857521.1356, 657175.3272 6857521.1356, 657175.3272 6867076.0360, 646417.3289 6867076.0360, 646417.3289 6857521.1356))', NULL, false, false, false, NULL, ARRAY['show','point','linestring','polygon','circle']::z_plume.meta_geo_tool[], NULL, 5),
    ('dcat:distribution / dcat:accessService / dcat:spatialResolutionInMeters', 'shared', 'Résolution spatiale en mètres', 'Résolution des données mises à disposition par le service, exprimée en mètres.', NULL, false, 'xsd:decimal', false, NULL, NULL, NULL, true, false, false, NULL, NULL, NULL, 82),
    ...
    ('dcat:distribution / dcat:accessService / dct:temporal', 'shared', 'Couverture temporelle', 'Période pour laquelle des données sont mises à disposition par le service.', NULL, true, NULL, false, NULL, NULL, NULL, true, false, false, NULL, NULL, NULL, 85),
    ...
    ('dcat:distribution / dcat:accessService / dcat:temporalResolution', 'shared', 'Résolution temporelle', 'Résolution temporelle des données mises à disposition par le service.', NULL, false, 'xsd:duration', false, NULL, NULL, NULL, false, false, false, NULL, NULL, NULL, 86),
    ...
    ('dcat:distribution / dct:conformsTo', 'shared', 'Conforme à', 'Standard, schéma, référentiel de coordonnées, etc. auquel se conforment les données de la distribution.', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/OgcEpsgFrance','http://www.opengis.net/def/crs/EPSG/0','http://registre.data.developpement-durable.gouv.fr/plume/IgnCrs'], NULL, NULL, 17),
    ...
    ('dcat:distribution / dcat:spatialResolutionInMeters', 'shared', 'Résolution spatiale en mètres', 'Résolution des données de la distribution, exprimée en mètres.', NULL, false, 'xsd:decimal', false, NULL, NULL, NULL, true, false, false, NULL, NULL, NULL, 24),
    ...
    ('dcat:distribution / dct:rights', 'shared', 'Contraintes légales', 'Autre contrainte d''ordre juridique applicable à la distribution (propriété intellectuelle, etc.).', 'url', false, NULL, false, NULL, NULL, NULL, true, false, false, ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/ISO19139RestrictionCode'], NULL, NULL, 32),
    ...
    LOOP
        ...
        FOR tplcat IN SELECT * FROM (
            VALUES
                ...
                ('Basique', 'adms:status', NULL),
                ('Basique', 'dct:accessRights', NULL),
                ('Basique', 'dct:accessRights / rdfs:label', NULL),
                ...
                ('Classique', 'dcat:distribution', NULL),
                ('Classique', 'dcat:distribution / dct:rights', NULL),
                ('Classique', 'dcat:distribution / dct:rights / rdfs:label', NULL),
                ...
                ('Donnée externe', 'adms:status', NULL),
                ...
                ('Donnée externe', 'dcat:distribution / dct:rights', NULL),
                ('Donnée externe', 'dcat:distribution / dct:rights / rdfs:label', NULL),
                ...
                ('INSPIRE', 'adms:status', NULL),
                ('INSPIRE', 'dcat:contactPoint', NULL),
                ('INSPIRE', 'dcat:contactPoint / vcard:fn', NULL),
                ('INSPIRE', 'dcat:contactPoint / vcard:hasEmail', NULL),
                ('INSPIRE', 'dcat:contactPoint / vcard:hasTelephone', NULL),
                ('INSPIRE', 'dcat:contactPoint / vcard:hasURL', NULL),
                ('INSPIRE', 'dcat:contactPoint / vcard:organization-name', NULL),
                ('INSPIRE', 'dcat:distribution', NULL),
                ('INSPIRE', 'dcat:distribution / adms:representationTechnique', ARRAY['http://inspire.ec.europa.eu/metadata-codelist/SpatialRepresentationType']),
                ('INSPIRE', 'dcat:distribution / dcat:accessService', NULL),
                ('INSPIRE', 'dcat:distribution / dcat:accessService / dcat:endpointDescription', NULL),
                ('INSPIRE', 'dcat:distribution / dcat:accessService / dcat:endpointURL', NULL),
                ('INSPIRE', 'dcat:distribution / dcat:accessService / dct:conformsTo', ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/DataServiceStandard']),
                ('INSPIRE', 'dcat:distribution / dcat:accessService / dct:type', ARRAY['http://inspire.ec.europa.eu/metadata-codelist/SpatialDataServiceType']),
                ('INSPIRE', 'dcat:distribution / dcat:accessURL', ARRAY['http://inspire.ec.europa.eu/metadata-codelist/LimitationsOnPublicAccess', 'http://registre.data.developpement-durable.gouv.fr/plume/ISO19139ClassificationCode', 'http://registre.data.developpement-durable.gouv.fr/plume/ISO19139RestrictionCode']),
                ('INSPIRE', 'dcat:distribution / dct:description', NULL),
                ('INSPIRE', 'dcat:distribution / dct:format', NULL),
                ('INSPIRE', 'dcat:distribution / dct:format / rdfs:label', NULL),
                ('INSPIRE', 'dcat:distribution / dct:license', NULL),
                ('INSPIRE', 'dcat:distribution / dct:license / rdfs:label', NULL),
                ('INSPIRE', 'dcat:distribution / dct:rights', ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/ISO19139RestrictionCode']),
                ('INSPIRE', 'dcat:distribution / dct:rights / rdfs:label', NULL),
                ('INSPIRE', 'dcat:distribution / dct:title', NULL),
                ('INSPIRE', 'dcat:keyword', NULL),
                ('INSPIRE', 'dcat:spatialResolutionInMeters', NULL),
                ('INSPIRE', 'dcat:theme', NULL),
                ('INSPIRE', 'dct:accessRights', NULL),
                ('INSPIRE', 'dct:accessRights / rdfs:label', NULL),
                ('INSPIRE', 'dct:accrualPeriodicity', NULL),
                ('INSPIRE', 'dct:creator', NULL),
                ('INSPIRE', 'dct:creator / foaf:mbox', NULL),
                ('INSPIRE', 'dct:creator / foaf:name', NULL),
                ('INSPIRE', 'dct:creator / foaf:phone', NULL),
                ('INSPIRE', 'dct:creator / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'dct:conformsTo', ARRAY['http://registre.data.developpement-durable.gouv.fr/plume/OgcEpsgFrance', 'http://registre.data.developpement-durable.gouv.fr/plume/IgnCrs', 'http://www.opengis.net/def/crs/EPSG/0']),
                ('INSPIRE', 'dct:conformsTo / dct:created', NULL),
                ('INSPIRE', 'dct:conformsTo / dct:title', NULL),
                ('INSPIRE', 'dct:conformsTo / dct:issued', NULL),
                ('INSPIRE', 'dct:conformsTo / dct:modified', NULL),
                ('INSPIRE', 'dct:conformsTo / foaf:page', NULL),
                ('INSPIRE', 'dct:created', NULL),
                ('INSPIRE', 'dct:description', NULL),
                ('INSPIRE', 'dct:identifier', NULL),
                ('INSPIRE', 'dct:issued', NULL),
                ('INSPIRE', 'dct:language', NULL),
                ('INSPIRE', 'dct:modified', NULL),
                ('INSPIRE', 'dct:provenance', NULL),
                ('INSPIRE', 'dct:provenance / rdfs:label', NULL),
                ('INSPIRE', 'dct:publisher', NULL),
                ('INSPIRE', 'dct:publisher / foaf:mbox', NULL),
                ('INSPIRE', 'dct:publisher / foaf:name', NULL),
                ('INSPIRE', 'dct:publisher / foaf:phone', NULL),
                ('INSPIRE', 'dct:publisher / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'dct:rightsHolder', NULL),
                ('INSPIRE', 'dct:rightsHolder / foaf:mbox', NULL),
                ('INSPIRE', 'dct:rightsHolder / foaf:name', NULL),
                ('INSPIRE', 'dct:rightsHolder / foaf:phone', NULL),
                ('INSPIRE', 'dct:rightsHolder / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'dct:spatial', NULL),
                ('INSPIRE', 'dct:spatial / dcat:bbox', NULL),
                ('INSPIRE', 'dct:spatial / dct:identifier', NULL),
                ('INSPIRE', 'dct:spatial / skos:inScheme', NULL),
                ('INSPIRE', 'dct:spatial / skos:prefLabel', NULL),
                ('INSPIRE', 'dct:temporal', NULL),
                ('INSPIRE', 'dct:temporal / dcat:startDate', NULL),
                ('INSPIRE', 'dct:temporal / dcat:endDate', NULL),
                ('INSPIRE', 'dct:title', NULL),
                ('INSPIRE', 'dqv:hasQualityMeasurement', NULL),
                ('INSPIRE', 'dqv:hasQualityMeasurement / dqv:isMeasurementOf', NULL),
                ('INSPIRE', 'dqv:hasQualityMeasurement / dqv:value', NULL),
                ('INSPIRE', 'foaf:page', NULL),
                ('INSPIRE', 'geodcat:custodian', NULL),
                ('INSPIRE', 'geodcat:custodian / foaf:mbox', NULL),
                ('INSPIRE', 'geodcat:custodian / foaf:name', NULL),
                ('INSPIRE', 'geodcat:custodian / foaf:phone', NULL),
                ('INSPIRE', 'geodcat:custodian / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'geodcat:distributor', NULL),
                ('INSPIRE', 'geodcat:distributor / foaf:mbox', NULL),
                ('INSPIRE', 'geodcat:distributor / foaf:name', NULL),
                ('INSPIRE', 'geodcat:distributor / foaf:phone', NULL),
                ('INSPIRE', 'geodcat:distributor / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'geodcat:originator', NULL),
                ('INSPIRE', 'geodcat:originator / foaf:mbox', NULL),
                ('INSPIRE', 'geodcat:originator / foaf:name', NULL),
                ('INSPIRE', 'geodcat:originator / foaf:phone', NULL),
                ('INSPIRE', 'geodcat:originator / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'geodcat:principalInvestigator', NULL),
                ('INSPIRE', 'geodcat:principalInvestigator / foaf:mbox', NULL),
                ('INSPIRE', 'geodcat:principalInvestigator / foaf:name', NULL),
                ('INSPIRE', 'geodcat:principalInvestigator / foaf:phone', NULL),
                ('INSPIRE', 'geodcat:principalInvestigator / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'geodcat:processor', NULL),
                ('INSPIRE', 'geodcat:processor / foaf:mbox', NULL),
                ('INSPIRE', 'geodcat:processor / foaf:name', NULL),
                ('INSPIRE', 'geodcat:processor / foaf:phone', NULL),
                ('INSPIRE', 'geodcat:processor / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'geodcat:resourceProvider', NULL),
                ('INSPIRE', 'geodcat:resourceProvider / foaf:mbox', NULL),
                ('INSPIRE', 'geodcat:resourceProvider / foaf:name', NULL),
                ('INSPIRE', 'geodcat:resourceProvider / foaf:phone', NULL),
                ('INSPIRE', 'geodcat:resourceProvider / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'geodcat:user', NULL),
                ('INSPIRE', 'geodcat:user / foaf:mbox', NULL),
                ('INSPIRE', 'geodcat:user / foaf:name', NULL),
                ('INSPIRE', 'geodcat:user / foaf:phone', NULL),
                ('INSPIRE', 'geodcat:user / foaf:workplaceHomepage', NULL),
                ('INSPIRE', 'owl:versionInfo', NULL)
