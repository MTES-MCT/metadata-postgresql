...
| `dct:conformsTo / skos:inScheme` | Registre | Registre de référence auquel appartient le standard. | [Registre de standards](http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister) |
