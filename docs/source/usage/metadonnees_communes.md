...
| `dct:spatial / skos:prefLabel` | Libellé |  |  |
...
| `dct:provenance / rdfs:label` | Texte |  |  |
| `adms:versionNotes` | Note de version | Différences entre la version courante des données et les versions antérieures. |  |
| `dct:conformsTo` | Conforme à | Standard, schéma, référentiel de coordonnées, etc. auquel se conforment les données. | [Système de coordonnées (registre de codes EPSG de l'OGC)](http://www.opengis.net/def/crs/EPSG/0) |
| `dct:conformsTo / skos:inScheme` | Registre |  | [Registre de standards](http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister) |
...
| `dct:conformsTo / dct:type` | Type de standard |  |  |
...
| `dct:accessRights / rdfs:label` | Mention |  |  |
| `dcat:contactPoint` | Point de contact | Entité à contacter pour obtenir des informations sur les données. |  |
| `dcat:contactPoint / vcard:fn` | Nom |  |  |
| `dcat:contactPoint / vcard:hasEmail` | Courriel |  |  |
| `dcat:contactPoint / vcard:hasTelephone` | Téléphone |  |  |
| `dcat:contactPoint / vcard:hasURL` | Site internet |  |  |
...
| `dct:publisher / foaf:name` | Nom |  |  |
| `dct:publisher / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `dct:publisher / foaf:mbox` | Courriel |  |  |
| `dct:publisher / foaf:phone` | Téléphone |  |  |
| `dct:publisher / foaf:workplaceHomepage` | Site internet |  |  |
| `dct:creator` | Auteur | Principal responsable de la production des données. |  |
| `dct:creator / foaf:name` | Nom |  |  |
| `dct:creator / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `dct:creator / foaf:mbox` | Courriel |  |  |
| `dct:creator / foaf:phone` | Téléphone |  |  |
| `dct:creator / foaf:workplaceHomepage` | Site internet |  |  |
| `dct:rightsHolder` | Propriétaire | Organisme ou personne qui détient des droits sur les données. |  |
| `dct:rightsHolder / foaf:name` | Nom |  |  |
| `dct:rightsHolder / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `dct:rightsHolder / foaf:mbox` | Courriel |  |  |
| `dct:rightsHolder / foaf:phone` | Téléphone |  |  |
| `dct:rightsHolder / foaf:workplaceHomepage` | Site internet |  |  |
| `geodcat:custodian` | Gestionnaire | Organisme ou personne qui assume la maintenance des données. |  |
| `geodcat:custodian / foaf:name` | Nom |  |  |
| `geodcat:custodian / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `geodcat:custodian / foaf:mbox` | Courriel |  |  |
| `geodcat:custodian / foaf:phone` | Téléphone |  |  |
| `geodcat:custodian / foaf:workplaceHomepage` | Site internet |  |  |
| `geodcat:distributor` | Distributeur | Organisme ou personne qui assure la distribution des données. |  |
| `geodcat:distributor / foaf:name` | Nom |  |  |
| `geodcat:distributor / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `geodcat:distributor / foaf:mbox` | Courriel |  |  |
| `geodcat:distributor / foaf:phone` | Téléphone |  |  |
| `geodcat:distributor / foaf:workplaceHomepage` | Site internet |  |  |
| `geodcat:originator` | Commanditaire | Organisme ou personne qui est à l'origine de la création des données. |  |
| `geodcat:originator / foaf:name` | Nom |  |  |
| `geodcat:originator / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `geodcat:originator / foaf:mbox` | Courriel |  |  |
| `geodcat:originator / foaf:phone` | Téléphone |  |  |
| `geodcat:originator / foaf:workplaceHomepage` | Site internet |  |  |
| `geodcat:principalInvestigator` | Maître d'œuvre | Organisme ou personne chargée du recueil des informations. |  |
| `geodcat:principalInvestigator / foaf:name` | Nom |  |  |
| `geodcat:principalInvestigator / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `geodcat:principalInvestigator / foaf:mbox` | Courriel |  |  |
| `geodcat:principalInvestigator / foaf:phone` | Téléphone |  |  |
| `geodcat:principalInvestigator / foaf:workplaceHomepage` | Site internet |  |  |
| `geodcat:processor` | Intégrateur | Organisation ou personne qui a retraité les données. |  |
| `geodcat:processor / foaf:name` | Nom |  |  |
| `geodcat:processor / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `geodcat:processor / foaf:mbox` | Courriel |  |  |
| `geodcat:processor / foaf:phone` | Téléphone |  |  |
| `geodcat:processor / foaf:workplaceHomepage` | Site internet |  |  |
...
| `geodcat:resourceProvider / foaf:name` | Nom |  |  |
| `geodcat:resourceProvider / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `geodcat:resourceProvider / foaf:mbox` | Courriel |  |  |
| `geodcat:resourceProvider / foaf:phone` | Téléphone |  |  |
| `geodcat:resourceProvider / foaf:workplaceHomepage` | Site internet |  |  |
| `geodcat:user` | Utilisateur | Organisme ou personne qui utilise les données. |  |
| `geodcat:user / foaf:name` | Nom |  |  |
| `geodcat:user / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `geodcat:user / foaf:mbox` | Courriel |  |  |
| `geodcat:user / foaf:phone` | Téléphone |  |  |
| `geodcat:user / foaf:workplaceHomepage` | Site internet |  |  |
...
| `dcat:distribution / dct:issued` | Date de publication |  |  |
...
| `dcat:distribution / dct:format / rdfs:label` | Nom |  |  |
| `dcat:distribution / dcat:compressFormat` | Format de compression | Format du fichier contenant les données sous une forme compressée. | [Type de fichier (UE)](http://publications.europa.eu/resource/authority/file-type) |
| `dcat:distribution / dcat:compressFormat / rdfs:label` | Nom |  |  |
...
| `dcat:distribution / dcat:accessService / dct:conformsTo` | Conforme à | Standard ou référentiel de coordonnées auquel se conforme le service. | [Standards de services de données](http://snum.scenari-community.org/Metadata/Vocabulaire/#DataServiceStandard), [Système de coordonnées (registre de codes EPSG de l'OGC)](http://www.opengis.net/def/crs/EPSG/0), [Protocoles (INSPIRE)](http://inspire.ec.europa.eu/metadata-codelist/ProtocolValue) |
| `dcat:distribution / dcat:accessService / dct:conformsTo / skos:inScheme` | Registre |  | [Registre de standards](http://snum.scenari-community.org/Metadata/Vocabulaire/#StandardsRegister) |
...
| `dcat:distribution / dcat:accessService / dct:conformsTo / dct:type` | Type de standard |  |  |
...
| `dcat:distribution / dcat:accessService / dct:accessRights / rdfs:label` | Mention |  |  |
...
| `dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:fn` | Nom |  |  |
| `dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:hasEmail` | Courriel |  |  |
| `dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:hasTelephone` | Téléphone |  |  |
| `dcat:distribution / dcat:accessService / dcat:contactPoint / vcard:hasURL` | Site internet |  |  |
...
| `dcat:distribution / dcat:accessService / dct:publisher / foaf:name` | Nom |  |  |
| `dcat:distribution / dcat:accessService / dct:publisher / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `dcat:distribution / dcat:accessService / dct:publisher / foaf:mbox` | Courriel |  |  |
| `dcat:distribution / dcat:accessService / dct:publisher / foaf:phone` | Téléphone |  |  |
| `dcat:distribution / dcat:accessService / dct:publisher / foaf:workplaceHomepage` | Site internet |  |  |
| `dcat:distribution / dcat:accessService / dct:creator` | Auteur | Principal acteur de la création du service. |  |
| `dcat:distribution / dcat:accessService / dct:creator / foaf:name` | Nom |  |  |
| `dcat:distribution / dcat:accessService / dct:creator / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `dcat:distribution / dcat:accessService / dct:creator / foaf:mbox` | Courriel |  |  |
| `dcat:distribution / dcat:accessService / dct:creator / foaf:phone` | Téléphone |  |  |
| `dcat:distribution / dcat:accessService / dct:creator / foaf:workplaceHomepage` | Site internet |  |  |
...
| `dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:name` | Nom |  |  |
| `dcat:distribution / dcat:accessService / dct:rightsHolder / dct:type` | Type |  | [Types d'entité en charge de la publication (UE)](http://purl.org/adms/publishertype/1.0) |
| `dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:mbox` | Courriel |  |  |
| `dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:phone` | Téléphone |  |  |
| `dcat:distribution / dcat:accessService / dct:rightsHolder / foaf:workplaceHomepage` | Site internet |  |  |
...
| `dcat:distribution / dcat:accessService / dct:spatial / skos:prefLabel` | Libellé |  |  |
...
| `dcat:distribution / dct:rights / rdfs:label` | Mention |  |  |
...
| `dcat:distribution / dct:accessRights / rdfs:label` | Mention |  |  |
