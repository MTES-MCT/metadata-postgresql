...
| `input_mask` | Masque de saisie, s'il y a lieu. | La valeur sera ignorée si le widget utilisé pour la catégorie ne prend pas en charge ce mécanisme. |
