...
| PostgreSQL 10 | oui | Nécessite l'extension `pgcrypto`. | 2022.06.10. PostgreSQL 10.12 + PlumePg 0.1.0 + pgcrypto 1.3 + Asgard 1.3.2[^withasgard]. |
| PostgreSQL 11 | oui | Nécessite l'extension `pgcrypto`. | 2022.06.10. PostgreSQL 11.9 + PlumePg 0.1.0 + pgcrypto 1.3 + Asgard 1.3.2. |
| PostgreSQL 12 | oui | Nécessite l'extension `pgcrypto`. | 2022.06.10. PostgreSQL 12.4 + PlumePg 0.1.0 + pgcrypto 1.3 + Asgard 1.3.2. |
| PostgreSQL 13 | oui | | 2022.06.10. PostgreSQL 13.0 + PlumePg 0.1.0 + pgcrypto 1.3[^withcrypto] + Asgard 1.3.2. |
| PostgreSQL 14 | oui | | 2022.06.10. PostgreSQL 14.2 + PlumePg 0.1.0 + pgcrypto 1.3 + Asgard 1.3.2. |
