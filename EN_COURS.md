...
| Formulaire à la volée              |        |        |        | Prise en charge des main widgets QLabel |
...
|     Quoi      |     A faire     |  Terminé   |  Qui   | Notes |
| ------------- | :-------------: | :---------: | :---------: |  --- |
| Bascule mode lecture/mode édition  |   X   |        |   DL   | |
| Sauvegarde                         |   X   |        |   DL   | |
| Réinitialisation                   |   X   |        |   DL   | |
| Export                             |   X   |        |   DL   | |
| Import                             |   X   |        |   DL   | |
| Choix du modèle                    |   X   |        |   DL   | |
| Activation du mode traduction      |   X   |        |   DL   | |
...
| Changer les couleurs par défaut des cadres |   X   |        |   DL   | Les bonnes sont [là](https://github.com/MTES-MCT/metadata-postgresql/blob/main/__doc__/10_creation_widgets.md#autres-groupes), et ce ne sont définitivement pas celles qui servent à ce stade. |
