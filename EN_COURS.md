...
| ------------- | :-------------: | :---------: | :---------: |  --- |
| Plume ne fonctionne qu'à partie de la version 3.10 et supérieure de Qgis |        |   Ok   |   DL/LL   |Le problème provient de la version de "psycopg2" qui est embarquée dans la version de Qgis (passage d'arguments)
